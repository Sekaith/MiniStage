...
$idcompte = isset($Profil['idcompte']) ? $Profil['idcompte'] : "";
...
<div class="panel-white">
	...
	<div class="panel-body">      		
        <select name="fct" id="fct" style="margin-left: 5%" required>
    ...
    <span class="span7 text-center" style="margin-left: 17.5%"><button type="submit" class="btn btn-primary btn-sucess">Ajouter formation</button></br></span>
