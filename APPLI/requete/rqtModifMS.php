...
//	where m.id= '.$_GET['id'].'';
    ...
    $rqt = 'SELECT m.idministage as id, tf.nom_typeformation  as typeformation, f.nom_formation as formation, f.idformation as idformation, p.civilite, p.nom_prof, date as dateUS, DATE_FORMAT(date, "%d-%m-%Y") AS dateFR, 
