...
$pageListeMS = new page_base('Mini-Stages');
$pageListeMS->corps .= '

 <a href="ListeMSAnt.php"><button align="right" type="submit" class="btn btn-sm btn-primary">
  <span class="glyphicon glyphicon-check"></span> Mini-Stages antérieurs au '.date('d-m-Y').'</button>
  </a></br></br>
				...
				<div class="panel-heading clearfix">
					<h4 class="panel-title">Liste des Mini-stages</h4>
                                ...
                                <div class="panel-body">
								   ...
								   <table id="ministage" class="display table" style="width: 100%; cellspacing: 0;">
                                        <thead>
                                            <tr>
