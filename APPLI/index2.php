                    ...
                    <div class="row">
                        <div class="col-md-5 center">
                            <div class="login-box">
                              <table width="100%">
                                  <tr>
                                    <td><img src="image/ministage.png" width="129" height="144" alt="logo_ministage"></td>
                                    <td><a  class="logo-name text-lg text-center" >Gestion et Réservations<br>
                                      des mini-stages
                                    </a></td>
									<td><a href="http://www.ac-nantes.fr/"><img src="image/ac-nantes.png" width="120" height="120" alt="logo_ac-nantes"></a></td>
                                  </tr>
                              </table>
