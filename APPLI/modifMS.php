	...
	<div class="panel-body">
		...
		id="formulaireModifMS" name="formulaireModifMS" onsubmit="return validerModifMS()">
				...
				<div class="col-sm-10">
					...
					readonly required value="'.$MS['typeformation'].' '.$MS['formation'].'">
            		</div></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						placeholder="début" readonly name="heure1" required value="'.$MS['hdebut'].'"/>
						<input size="25" type="text" id="heure2" class="col-sm-2 control-label" 
						placeholder="fin" readonly name="heure2" required" value="'.$MS['hfin'].'"/> 
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
					<select name="civilite" class="form-control" onchange="verifList(this)" style="width:150px" id="civilite" value="'.$MS['prenomProf'].'">
