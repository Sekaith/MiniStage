...
<h2 style="text-align:center">CONVENTION de MINI-STAGE<h4><br>Année scolaire 2022-2023</h4></h2>
...
<p style="text-align:left;font">Et l'établissement demandeur : <br><b><br><br></b> </p>

</div>

<div style="position:absolute;right:100px;top:190px;line-height:13pt;">

<p style="text-align:left;font-size:14px;"> Entre l'établissement d'accueil : <br><b><? echo $Conv['type'] ?>  <? echo $Conv['nometab'] ?><br><? echo $Conv['adresse'] ?> - <? echo $Conv['cp'] ?> <? echo $Conv['ville'] ?><br>Tél. : <? echo $Conv['tel'] ?><br>Email :<span  style="color:#1E00FF;font-weight: bold;" > <? echo $Conv['mail'] ?></span></b></p>

</div>

<div style="position:absolute;left:20px;top:300px;line-height:15pt;">

<p style="text-align:left;font-size:14px;"> <br>et l'élève stagiaire : <b><br></b>élève en classe de   ....... <br>date de naissance : ....... / ........ / ......... <br><br>Mini-stage suivi : <b> </b><br>Date : <b><? echo ($Conv['date']) ?> </b> Horaires : <b></b> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Professeur encadrant : <b></b>  
</p>
...
<div style="position:absolute;left:20px;top:470px;right:10px;">
...
<div style="position:absolute;left:20px;top:665px;right:10px;">
...
Une fois complétée, il envoie une copie à l’établissement d’accueil par courrier électronique à l'adresse ci-dessus.<br>
ATTENTION : Le mini-stage n'est validé qu'à la réception de la convention</p> </blockquote>



</div>
<div style="position:absolute;left:20px;top:755px;right:10px;">
<blockquote>
